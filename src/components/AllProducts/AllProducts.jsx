          ...
          <form className="mx-auto md:w-1/2 mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                type="search"
                id="search"
                className="block w-full p-4 ps-10 text-sm text-gray-900 border border-green-600 rounded-lg bg-gray-200 focus:ring-green-500 focus:border-green-500 focus:outline-none dark:bg-green-700 dark:border-gray-600 dark:placeholder-green-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500"
                  ...
                  <i
                    ...
                    className={`fa-solid fa-heart fa-beat-fade ${
                      wishlistCheck.some((i) => i == product.id)
                        ? "text-red-500 "
                        : "hover:text-red-500"
                    } absolute top-5 left-2 duration-300 text-2xl`}
                  ></i>
